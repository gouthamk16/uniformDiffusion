...
And the best part: check out some stories this model actually wrote on an RTX 4060 laptop GPU, from a [short ~20-minute run](generated_samples.txt) and from a [longer run](generated_samples_73k.txt) that trained further and reached a lower loss.
